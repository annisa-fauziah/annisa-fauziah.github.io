	...
	*/
	...
	function slider (data){
		if (data.tipe == "H" || data.tipe == "h"){
			//slider H
			if (data.label != ""){
				teks(data.minS+" "+data.label, data.x+20, data.y+5, "12pt Calibri", "white", "right");
				teks(data.maxS+" "+data.label, data.x+45+data.p, data.y+5, "12pt Calibri", "white", "left");
			}
			...
			//slider V
			if (data.label != ""){
				teks(data.maxS+" "+data.label, data.x, data.y+5, "12pt Calibri", "white", "center");
				teks(data.minS+" "+data.label, data.x, data.y+data.p+43, "12pt Calibri", "white", "center");
			}
